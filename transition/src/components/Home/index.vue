...
<div class="wrapper row3">
  <main class="hoc container clear">
    ...
    <div class="group">
      ...
      <div class="one_half"><img class="inspace-10 borderedbox" src="@/assets/images/demo/480x400.png" alt=""></div>
    </div>
    <!-- ################################################################################################ -->
    <!-- / main body -->
    <div class="clear"></div>
  ...
  <div class="hoc container clear">
    ...
    <ul class="nospace group services">
      <li class="one_third first btmspace-30">
        <article class="bgded overlay" style="background-image:url('@/assets/images/demo/320x240.png');">
...
<div class="wrapper row3">
  <section class="hoc container clear">
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="@/assets/images/demo/320x240.png" alt=""></a>
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="@/assets/images/demo/320x240.png" alt=""></a>
